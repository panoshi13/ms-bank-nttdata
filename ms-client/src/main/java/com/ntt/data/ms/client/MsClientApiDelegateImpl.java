...
public class MsClientApiDelegateImpl implements CustomersApiDelegate {
    ...
    @Override
    public Mono<ResponseEntity<CustomerResponse>> createClient(
    ...
    @Override
    public Mono<ResponseEntity<InlineResponse200>> deleteClient(String id,
                                                                ServerWebExchange exchange) {
    ...
    @Override
    public Mono<ResponseEntity<CustomerResponse>> updateClient(
        Mono<CustomerRequest> customerRequest, ServerWebExchange exchange) {
        return customerRequest
            .map(clientMapper::mapToCustomer)
    ...
    @Override
    public Mono<ResponseEntity<CustomerProductMovementsResponse>> getCustomerProductMovements(
        String customerId, String productId, ServerWebExchange exchange) {
        return customerService.getMovement(customerId, productId)
            .map(ResponseEntity::ok);
    }

    @Override
    public Mono<ResponseEntity<CustomerProductBalanceResponse>> getCustomerProductBalance(
    ...
    @Override
    public Mono<ResponseEntity<MonthlyBalanceReportResponse>> getMonthlyBalanceReport(
    ...
    @Override
    public Mono<ResponseEntity<ConsolidatedSummaryResponse>> getConsolidatedSummary(
